<template>
    <v-app>
        <v-parallax dark height="800"  class="blue darken-4" style="margin-top:-8px">
            <v-container>
                <v-row  align="center" >
                    <v-col lg="7">
                        <h3 class="text-h1  font-weight-bold "> Be confident in every purchase. </h3>
                    ...
                    <v-col lg="5" align="center" >
                        <v-img src="assets/img/logo.png" class="rounded-circle" width="500px"></v-img>
                    </v-col>
                </v-row>
            </v-container>
        </v-parallax>
...
import sServices from './sections/Services';
import sAbout from './sections/About';
...
export default {
    components :{
        ProductFeature,sServices,sAbout,sContact
    },
}
</script>
